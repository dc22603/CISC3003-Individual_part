                ...
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><i class="fa fa-indian-rupee-sign"></i>&nbsp;&nbsp;<?= number_format($row['product_price'],2); ?></td>
                            <input type="hidden" class="pprice" value="<?= $row['product_price'] ?>">
                            <td><input type="number" class="form-control itemQty" value="<?= $row['qty']?>" style="width:75px"></td>
                            <td><i class="fa fa-indian-rupee-sign"></i>&nbsp;&nbsp;<?= number_format($row['total_price'],2); ?></td>
                        ...
                        <tr><?php $grand_total +=$row['total_price']; ?></tr>
                        <?php endwhile; ?>
                        <tr>
                            <td colspan="3">
                            ...
                            <td><b><i class="fas fa-indian-rupee-sign"></i>&nbsp;&nbsp;<?= number_format($grand_total,2) ?></b></td>
